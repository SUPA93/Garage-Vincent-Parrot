...
/*INSERT INTO menu (page_url, title, head_title, meta_description, exclude)
 VALUES
 ('index.php', 'ACCUEIL', 'Accueil', 'Garage Vincent Parrot', 0),
 ('prestations.php', 'SERVICES', 'Nos Services', 'Découvrez nos services', 0),
 ('garages.php', 'GARAGES', 'Nos Garages', 'Nos Garages près de chez vous', 0),
 ('occasions.php', 'OCCASIONS', 'Nos Occasions', 'Véhicules vérifiés remis en état et garantis!', 0),
 ('contact_form.php', 'CONTACT', 'Contact', 'N\'hésitez pas à nous solliciter', 0),
 ('connexion.php', 'CONNEXION', 'Connectez-vous', 'Portail d\'accès aux services', 1),
 ('occasion_detail.php', 'DÉTAILS', 'Détails du véhicule', 'Votre véhicule d\'occasion plus en détail', 1),
 ('subscribe.php', 'INSCRIPTION', 'Inscription', 'Portail d\'inscription nouveau client', 1),
 ('devis.php', 'VOTRE DEVIS', 'Devis en ligne', 'Un devis en ligne adapté et garanti', 1),
 ('admin.php', 'Hello Patron', 'Interface', 'Interface d\'administration', 1),
 ('occasions_handler.php', 'Gérer les annonces', 'Gérer les annonces', 'Gestion des véhicules d\'occasion', 1); */
